...
export const POPULAR_SCHEMAS: SchemaDefinition[] = [
  ...
  },
  {
    uid: '0x8',
    name: '0xScore',
    description: 'On-chain reputation and credit scoring protocol.',
    provider: '0xScore',
    logoUrl: 'https://0xscore.finance/favicon.ico',
    docsUrl: 'https://0xscore.finance/',
    category: 'Identity',
    tags: ['Score', 'Reputation'],
    ecosystem: 'Verax',
  },
  {
    uid: '0x9',
    name: 'Aspecta',
    description: 'AI-powered identity for developers and creators.',
    provider: 'Aspecta',
    logoUrl: 'https://aspecta.id/favicon.ico',
    docsUrl: 'https://aspecta.id/',
    category: 'Identity',
  ...
  },
  {
    ...
    description: 'Privacy-first attestation layer for Web3.',
    provider: 'Automata',
    logoUrl: 'https://www.ata.network/favicon.ico',
    docsUrl: 'https://www.ata.network/',
    category: 'Identity',
    tags: ['Privacy', 'Attestation'],
    ecosystem: 'Verax',
  },
  {
    uid: '0x11',
    name: 'Hapi',
    description: 'On-chain cybersecurity protocol.',
    provider: 'Hapi',
    logoUrl: 'https://hapi.one/favicon.ico',
    docsUrl: 'https://hapi.one/',
    category: 'Identity',
    tags: ['Security', 'KYC'],
    ecosystem: 'Verax',
  },
  {
    uid: '0x12',
    name: 'Privado ID',
    description: 'Decentralized identity and verifiable credentials.',
    provider: 'Privado ID',
    logoUrl: 'https://privado.id/favicon.ico',
    docsUrl: 'https://privado.id/',
    category: 'Identity',
  ...
  },
  {
    uid: '0x13',
    name: 'RubyScore',
    description: 'Ranking and reputation system for on-chain activity.',
    provider: 'RubyScore',
    logoUrl: 'https://rubyscore.io/favicon.ico',
    docsUrl: 'https://rubyscore.io/',
    category: 'Identity',
    tags: ['Ranking', 'Score'],
    ecosystem: 'Verax',
  },
  {
    uid: '0x14',
    name: 'Sumsub',
    description: 'Verification platform for identity and compliance.',
    provider: 'Sumsub',
    logoUrl: 'https://sumsub.com/favicon.ico',
  ...
  },
  {
    uid: '0x15',
    name: 'Trusta',
    description: 'AI-driven sybil resistance and reputation protocol.',
    provider: 'Trusta',
    logoUrl: 'https://www.trustalabs.ai/favicon.ico',
    docsUrl: 'https://www.trustalabs.ai/',
    category: 'Identity',
    tags: ['Sybil', 'AI'],
    ecosystem: 'Verax',
  }
